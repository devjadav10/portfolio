...
const Hero = () => {
  return (
    <section className="relative h-[100dvh] w-full flex flex-col items-center justify-center px-6 bg-background overflow-hidden">
      ...
      {/* Background Mesh (Existing implementation) */}
      ...
      <div className="relative z-10 max-w-5xl w-full text-center leading-[1.1]">
        ...
        {/* Line 2: Role + Conditional Dino Image */}
        <div className="flex flex-wrap items-center justify-center gap-x-2 md:gap-x-4 text-3xl md:text-7xl font-serif tracking-tighter mt-2 md:mt-4">
          ...
          {/* HIDDEN BELOW 400PX: 
            Uses Tailwind's arbitrary value support for the 400px breakpoint.
          */}
          <div className="hidden min-[400px]:block group relative w-[70px] md:w-[115px] h-[40px] md:h-[65px] glass-capsule rotate-[3deg] overflow-hidden flex-shrink-0">
            <img 
              src="/images/Dino.png" 
      ...
      {/* Description Subtext with Highlight Animation */}
      <div className="relative z-10 mt-16 text-center">
        <HighlightText 
          text={DESCRIPTION}
          className="sub-description mx-auto max-w-2xl px-4"
        />
      </div>
    </section>
  );
